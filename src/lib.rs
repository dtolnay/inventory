...
//! 
//! To export '__wasm_call_ctors' it is simple:
//! ```
//! // You can remove the cfg attributes if you are only compiling for wasm.
//! #[cfg(target_family = "wasm")]
//! unsafe extern "C" {
//!     fn __wasm_call_ctors();
//! }
//! 
//! // Now you just need to call that function once, somewhere, before you use collect!.
//! // For example, at the start of main.
//! fn main() {
//!     #[cfg(target_family = "wasm")]
//!     unsafe {
//!         __wasm_call_ctors();
...
#![doc(html_root_url = "https://docs.rs/inventory/0.3.17")]
#![no_std]
